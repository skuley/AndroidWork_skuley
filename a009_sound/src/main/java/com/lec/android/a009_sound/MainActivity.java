    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPlay1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // 음향 재생
                sp.play(soundId[0], // 준비한 soundId 리소스 id
                        1, // 왼쪽볼륨 float type 0.0 ~ 1.0
                        1, // 오른쪽 볼륨 float
                        0, // 우선순위
                        0, // 반복회수 int,  0 : 반복안함 -1 : 무한반복
                        1f // 재생속도 float type, 0.5 (절반속도) ~ 2.0 (2배속)
                        );
            }
        });
        ...
        btnPlay2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // 음향 재생
                sp.play(soundId[1], // 준비한 soundId 리소스 id
                        1, // 왼쪽볼륨 float type 0.0 ~ 1.0
                        1, // 오른쪽 볼륨 float
                        0, // 우선순위
                        2, // 반복회수 int,  0 : 반복안함 -1 : 무한반복
                        2f // 재생속도 float type, 0.5 (절반속도) ~ 2.0 (2배속)
                );
            }
        });
        ...
        btnPlay3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // 음향 재생
                sp.play(soundId[2], // 준비한 soundId 리소스 id
                        1, // 왼쪽볼륨 float type 0.0 ~ 1.0
                        1, // 오른쪽 볼륨 float
                        0, // 우선순위
                        -1, // 반복회수 int,  0 : 반복안함 -1 : 무한반복
                        0.5f // 재생속도 float type, 0.5 (절반속도) ~ 2.0 (2배속)
                );
            }
        });
