...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        thread1.setDaemon(true); // 메인 스레드와 종료 동기화.
    ...
    public void mOnClick(View v){
        ...
        tvBackValue1.setText("작업스레드1 : " + backValue1);
        tvBackValue2.setText("작업스레드2 : " + backValue2);
    } // mOnClick
    ...
    // 1. Thread를 상속받은 작업 스레드
    class BackThread extends Thread{
        @Override
        public void run() {
            while(true){
                backValue1++; // run 안에 있는 작업 쓰레드로 돌아간다
                ...
                //tvBackValue1.setText("" + backValue1); // CalledFromWrongThreadException: Only the original thread that created a view hierarchy can touch its views. 왜??
            }
        }
    }
