...
public class PhonebookAdapter extends RecyclerView.Adapter<PhonebookAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        // 주어진 ViewGroup 으로부터 LayoutInflator 추출
        ...
        // 위에서 만든 새로운 View를 ViewHolder에 담아 리턴
...
//   Selection Widget 에서 수시로 getItemCount() 를 호출하여 뷰를 업데이트 한다
    ...
    // nested class (staic inner) 로 ViewHolder 클래스 정의
    static class ViewHolder extends RecyclerView.ViewHolder{

        // ViewHolder 에 담긴 각가의 View 들을 담을 변수
        ImageView ivPhoto;
        ...
        // 생성자 필수!
        public ViewHolder(@NonNull View itemView) { // item 레이아수의 View 객체가 전달됨
            super(itemView);
            ...
            swOnOff.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // 값이 변경 되었을때
                @Override
